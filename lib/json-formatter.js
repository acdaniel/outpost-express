...
module.exports = function formatJson(res, options) {
  ...
  function formatEntity (entity) {
    ...
    //add embedded
    if (options.includeEmbedded && entity.embedded) {
      obj._embedded = {};
    ...
    // add links
    if (options.includeLinks && entity.links) {
      obj._links = {};
    ...
    // add actions
    if (options.includeActions && entity.actions) {
      obj._actions = {};
