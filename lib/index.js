  ...
  return [
    function invokeAction (req, res, next) {
      ...
      var ctx = {
        ...
        auth: {},
        params: {
          input: _.merge({}, req.query, req.body, req.files)
        }
      };
    ...
    function renderEntity (req, res, next) {
      ...
      if (req.query.access_token) {
        formatOptions.queryString = { access_token: req.query.access_token };
      }
      if (req.query._actions) {
        formatOptions.includeActions = !!req.query._actions;
      }
      if (req.query._links) {
        formatOptions.includeLinks = !!req.query._links;
      }
      if (req.query._embedded) {
        formatOptions.includeEmbedded = !!req.query._embedded;
      }
      if (req.query._meta) {
        formatOptions.includeMeta = !!req.query._meta;
      }
